...
######################################################################
from transformers.donghn.int_cfg import opt, QInfo
from transformers.donghn.int_quant import Quantizer
######################################################################
...
def main():
    ...
    if training_args.do_eval:
        ...
        ##################    
            ...
            part = 0.05
            calib_samples = int(len(eval_dataset)*part)
            print("Using %d samples (%d pct.) from training data for run calibration ..." %(calib_samples, part*100))
            eval_dataset = eval_dataset.select(range(calib_samples))
        else:
