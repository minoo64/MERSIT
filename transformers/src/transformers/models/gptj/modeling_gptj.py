...
class GPTJAttention(nn.Module):
    def __init__(self, config):
        ...
        self.k_proj = IntQLinear(self.embed_dim, self.embed_dim, bias=False)
        self.v_proj = IntQLinear(self.embed_dim, self.embed_dim, bias=False)
        self.q_proj = IntQLinear(self.embed_dim, self.embed_dim, bias=False)
        self.out_proj = IntQLinear(self.embed_dim, self.embed_dim, bias=False)
...
class GPTJMLP(nn.Module):
    def __init__(self, intermediate_size, config):  # in MLP: intermediate_size= 4 * embed_dim
        ...
        self.fc_in = IntQLinear(embed_dim, intermediate_size)
        self.fc_out = IntQLinear(intermediate_size, embed_dim)
...
class GPTJModel(GPTJPreTrainedModel):
    def __init__(self, config):
        ...
        self.wte = IntQEmbedding(config.vocab_size, self.embed_dim)
...
class GPTJForCausalLM(GPTJPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.lm_head = IntQLinear(config.n_embd, config.vocab_size)
...
class GPTJForSequenceClassification(GPTJPreTrainedModel):
    def __init__(self, config):
        ...
        self.score = IntQLinear(config.n_embd, self.num_labels, bias=False)
